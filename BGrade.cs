...
{
    [Info("BGrade", "Ryan / Rustoria.co", "1.1.03")]
                ...
                case "4":
                    {
                        ...
                        chatMsgs.Add("Notice.SetGrade".Lang(player.UserIDString, grade, $"Words.Grade.{grade}".Lang(player.UserIDString)));
                ...
                case "help":
                    {
                        ...
                        if ( BGradePlayer.Players.TryGetValue( player, out bgradePlayer ) )
                        {
                            ...
                            chatMsgs.Add( "Command.Settings.Grade".Lang( player.UserIDString, fetchedGrade == 0 ? "Words.Disabled".Lang( player.UserIDString ) : fetchedGrade.ToString(), $"Words.Grade.{fetchedGrade}".Lang(player.UserIDString) ) );
                        }
